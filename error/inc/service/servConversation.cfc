<cfcomponent extends="cf-compendium.inc.resource.base.service" output="false">
	<cffunction name="getConversations" access="public" returntype="query" output="false">
		...
		<cfquery name="results" datasource="#variables.datasource.name#">
			SELECT COUNT(e."errorID") AS numErrors, MAX(e."loggedOn") AS lastLogged, e.message, e.detail, e.type, e.code, e."errorCode", t.template, t.line, t.column
			...
			LEFT JOIN "#variables.datasource.prefix#error"."trace" AS t
				ON e."errorID" = t."errorID"
					AND t."orderBy" = 1
			GROUP BY e.message, e.detail, e.type, e.code, e."errorCode", t.template, t.line, t.column
